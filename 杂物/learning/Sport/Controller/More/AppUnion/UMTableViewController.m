...
#define UM_APP_UNION_APP_KEY @"52984c62be19a638cda923b4"
- (void)setupTableView
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain appkey:UM_APP_UNION_APP_KEY slotId:nil currentViewController:self];
